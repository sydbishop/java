...
public class MyLinkedListSydneyTester {
	...
	public static void main(String[] args) {
		...
		linkedListIteratorTest1();
		
	}
	public static void linkedListTester1() {
		printTestName("[1] addFirst() Tester");
		MyLinkedListSydney<String> myList = new MyLinkedListSydney<>();
	...
	public static void linkedListIteratorTest1() {
		...
		myList.addFirst("DEF");
		myList.addFirst("ABC");
		MyLinkedListSydney<String>.Iterator iter = myList.iterator();
		while(iter.hasNext()) {
